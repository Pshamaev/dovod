// Modified for DOVOD: adds the Russian (ru) locale, makes it the default for
// non-English/Chinese systems and rebrands the product name to Довод.
import {
  createContext,
  useContext,
  useMemo,
...
export const WEB_SHELL_LANGUAGES = ['ru', 'en', 'zh-CN'] as const;
...
const EN: Messages = {
  ...
  'agent.create.method.qwen': 'Generate with Довод',
  'agent.create.method.qwen.recommended': 'Generate with Довод (Recommended)',
  ...
  'workflowRuns.emptySavedHint':
    'Select New to create one with Довод, save a completed run from the terminal, or add a .js file under .qwen/workflows.',
  ...
  'help.intro':
    'Довод answers legal questions from the sources it finds, works with the case files in your workspace and drafts documents with your permission.',
  ...
  'language.invalid': 'Invalid language. Available: ru, en, zh-CN',
  'language.options': 'Available options:',
  'language.set': 'Set UI language',
  'language.usage': 'Usage: /language ui [ru|en|zh-CN]',
  ...
  'channels.description':
    'Connect Довод to the places where your team already works.',
  'channels.summary': (v) =>
  ...
  'channels.startsWithServe': 'Connect when Довод starts',
  'channels.startsWithServe.description':
    'Automatically bring this Channel online after Довод starts.',
  'channels.unsupported.title': 'Channel management is not supported',
  'channels.unsupported.description':
    'Update Довод to a version that supports Channel management.',
  'channels.readOnly.title': 'Channel management is read-only',
  'channels.readOnly.description':
    'Restart Довод with a bearer token to control channels.',
  ...
  'settings.localControl.description':
    'Continue this Довод session from a phone on the same trusted network.',
...
const ZH: Messages = {
  ...
  'agent.create.method.qwen': '使用 Довод 生成',
  'agent.create.method.qwen.recommended': '使用 Довод 生成（推荐）',
  ...
  'workflowRuns.emptySavedHint':
    '可以点击“新建”让 Довод 创建、在终端中保存一次已完成的运行，或在 .qwen/workflows 下添加 .js 文件。',
  ...
  'help.intro':
    'Довод 依据检索到的法律来源回答问题，处理工作区中的案件材料，并在你的许可下起草文书。',
  ...
  'language.invalid': '语言无效。可用值：ru, en, zh-CN',
  'language.options': '可用选项：',
  'language.set': '设置 UI 语言',
  'language.usage': '用法：/language ui [ru|en|zh-CN]',
  'localCommand.noSession':
  ...
  'settings.title': '设置',
  'channels.title': '频道',
  'channels.description': '让 Довод 在团队日常使用的平台中收发消息。',
  'channels.summary': (v) =>
  ...
  'channels.startsWithServe': 'Довод 启动时自动连接',
  'channels.startsWithServe.description': 'Довод 启动后自动让该频道上线。',
  'channels.unsupported.title': '当前版本不支持频道管理',
  'channels.unsupported.description': '请升级 Довод 到支持频道管理的版本。',
  'channels.readOnly.title': '频道管理为只读模式',
  'channels.readOnly.description':
    '请使用 bearer token 重启 Довод，以控制频道。',
...
// Modified for DOVOD: Russian catalog. Keys missing here fall back to EN.
const RU: Messages = {
  'agentType.general-purpose': 'Универсальный',
  'agentType.explore': 'Исследование',
  'agentType.statusline-setup': 'Настройка строки состояния',
  'agentType.review-agent': 'Проверяющий агент',
  'agentType.test-engineer': 'Тест-инженер',
  'agentType.fork': 'Ответвление',
  'about.auth': 'Авторизация',
  'about.baseUrl': 'Адрес API',
  'about.fastModel': 'Быстрая модель',
  'about.memoryUsage': 'Память',
  'about.model': 'Модель',
  ...
  'about.title': 'Состояние',
  'agents.title': 'Агенты',
  'approval.execQuestion': (v) => `Разрешить выполнение: «${v?.tool ?? ''}»?`,
  ...
  'approval.option.allowOnceAndSwitchToDefault':
    'Разрешить один раз и перейти в обычный режим',
  'approval.option.restorePrevious': 'Да, вернуть прежний режим',
  'approval.option.rejectOnce': 'Отклонить',
  ...
  'askUser.submitOptionUnavailable': 'Вариант отправки недоступен',
  'askUser.ignore': 'Пропустить',
  'askUser.multiHint': 'несколько вариантов',
  'askUser.progress': (v) => `${v?.current ?? 0}/${v?.total ?? 0} вопросов`,
  'askUser.selectAnswer': 'Выберите ответ',
  'askUser.typePlaceholder': 'Введите текст...',
  'attachment.showPreview': 'Просмотр',
  'attachment.showSource': 'Исходник',
  'attachment.readFailed': 'Не удалось прочитать вложение.',
  'attachment.loadingFile': 'Загрузка файла...',
  'attachment.loadingPreview': 'Загрузка просмотра...',
  'auth.title': 'Подключить провайдера',
  'auth.notSet': '(не задано)',
  'chat.scrollToBottom': 'К концу переписки',
  'code.copy': 'Копировать',
  'code.copied': 'Скопировано!',
  'common.copy': 'Копировать',
  'common.download': 'Скачать',
  'common.downloading': 'Скачивание…',
  'common.downloadFailed': (v) => `Не удалось скачать: ${v?.message ?? ''}`,
  'common.open': 'Открыть',
  'common.openFailed': (v) => `Не удалось открыть ссылку: ${v?.message ?? ''}`,
  'common.na': 'н/д',
  'common.server': 'Сервер',
  'common.agent': 'Агент',
  'common.auto': 'авто',
  'common.runtime': 'Среда',
  ...
  'common.enterSelect': 'Enter — выбрать',
  ...
  'common.search': 'Поиск',
  'common.valid': 'верно',
  'common.clients': (v) => `клиентов: ${v?.count ?? 0}`,
  ...
  'composer.upload.error.noDaemon': 'Нет соединения со службой',
  'composer.upload.error.tooLarge': (v) =>
    `Файл больше допустимого размера ${v?.limit ?? ''}`,
  'composer.upload.error.tooManyFiles': (v) =>
    `Ещё ${v?.count ?? 0} файл(ов) не добавлено (ограничение на пакет)`,
  'composer.upload.cancel': 'Отменить загрузку',
  'composer.upload.dismiss': 'Скрыть',
  'composer.upload.renamed': 'Сохранено как',
  'composer.upload.drop': 'Перетащите файлы',
  'composer.dropChoice.title': (v) =>
    Number(v?.count) === 1
      ? 'Добавить файл'
      : `Добавить файлов: ${v?.count ?? 0}`,
  'composer.dropChoice.description':
    'Прикрепите файлы к сообщению, чтобы ассистент их прочитал, или загрузите их в рабочую папку и вставьте ссылки через @.',
  'composer.dropChoice.cancel': 'Отмена',
  'composer.dropChoice.upload': 'Загрузить в рабочую папку',
  'composer.dropChoice.reference': 'Прикрепить к сообщению',
  'composer.dropChoice.moreFiles': (v) => `и ещё ${v?.count ?? 0} файл(ов)`,
  'composerAdd.trigger': 'Добавить к сообщению',
  'composerAdd.emptyState': 'Здесь нет доступных действий',
  'composerAdd.noResults': 'Ничего не найдено',
  ...
  'composerAdd.file.attachDisabled': 'Вложения к сообщению недоступны',
  'composerAdd.file.uploadDisabled': 'Загрузка в рабочую папку недоступна',
  'composerAdd.referenceFile.label': 'Сослаться на файл',
  'composerAdd.referenceFile.searchPlaceholder': 'Поиск файлов в рабочей папке',
  'composerAdd.extensions.label': 'Расширения',
  'composerAdd.extensions.empty': 'Нет включённых расширений',
  'composerAdd.mcp.label': 'MCP',
  'composerAdd.mcp.empty': 'Нет доступных MCP-серверов',
  'composerAdd.skills.label': 'Навыки',
  'contextUsage.title': 'Использование контекста',
  'contextUsage.contextWindow': 'Окно контекста',
  'contextUsage.used': 'Занято',
  'contextUsage.free': 'Свободно',
  'contextUsage.tokens': 'токенов',
  'contextUsage.model': 'Модель',
  'contextUsage.messages': 'Сообщения',
  'contextUsage.systemPrompt': 'Системный промпт',
  ...
  'contextUsage.usageByCategory': 'По категориям',
  'copy.failedFallback': 'Не удалось скопировать в буфер обмена',
  'copy.noOutput': 'В истории нет ответов',
  'copy.noText': 'В последнем ответе нет текста для копирования.',
  'copy.codeMissing': 'В последнем ответе нет подходящего блока кода.',
  'copy.outputCopied': 'Последний ответ скопирован в буфер обмена',
  'copy.toClipboard': (v) =>
    `${v?.label ?? 'Выделенное'} скопировано в буфер обмена`,
  'daemon.title': 'Состояние службы',
  'daemon.loading': 'Загрузка состояния службы...',
  'delete.cannotCurrent': 'Нельзя удалить текущую активную сессию.',
  'delete.action': 'Удалить',
  'delete.deleted': 'Сессия удалена.',
  'delete.deletedCount': (v) => `Удалено сессий: ${v?.count ?? 0}.`,
  'delete.deleting': 'Удаление...',
  'delete.none': 'Нет сессий для удаления',
  'delete.notFound': 'Сессия не найдена — возможно, уже удалена.',
  'delete.selected': (v) => `выбрано: ${v?.count ?? 0}`,
  'delete.title': 'Удалить сессию',
  'dialog.footer.close': 'Esc — закрыть',
  'dialog.footer.confirmCancel': 'Enter — подтвердить · Esc — отмена',
  'dialog.footer.menu': 'Esc — в меню',
  'dialog.footer.mcpSelect': '↑↓ — навигация · Enter — выбрать · Esc — назад',
  'dialog.footer.navSelectCancel':
    '↑↓ — навигация · Enter — выбрать · Esc — отмена',
  'dialog.footer.navSelectClose':
    '↑↓ — навигация · Enter — выбрать · Esc — закрыть',
  'dialog.footer.navSelectMenu':
    '↑↓ — навигация · Enter — выбрать · Esc — в меню',
  'dialog.footer.navOpenClose':
    '↑↓ — навигация · Enter — открыть · Esc — закрыть',
  'dialog.footer.navOpenMenu':
    '↑↓ — навигация · Enter — открыть · Esc — в меню',
  'dialog.footer.back': 'Esc — назад',
  'dialog.footer.backClose': 'Esc — закрыть',
  'dialog.footer.search':
    'Введите текст для поиска · Enter — применить · Esc — очистить',
  ...
  'editor.hintNext': 'далее',
  'editor.hintPrev': 'назад',
  'editor.hintSearch': 'поиск',
  'editor.noHistory': 'Нет совпадений в истории',
  'editor.placeholder': 'Напишите вопрос или укажите файл через @',
  'editor.shellPlaceholder': 'Введите команду терминала',
  'editor.send': 'Отправить сообщение',
  'editor.imagesSkipped': (v) =>
    `Файлов недоступно и пропущено: ${v?.count ?? 0}.`,
  'editor.imagesReadFailed': (v) =>
    `Не удалось прочитать файлов: ${v?.count ?? 0}.`,
  'editor.connectionDisconnected':
    'Соединение прервано. Повторите после восстановления связи.',
  'editor.sessionLoading': 'Сессия ещё загружается. Попробуйте чуть позже.',
  'editor.processing': 'Идёт обработка. Новые сообщения встанут в очередь.',
  'editor.searchPlaceholder': 'введите текст для поиска...',
  'editor.newSessionSuggestionTitle': 'Похоже на новую тему',
  'editor.newSessionSuggestionStart': 'Отправить в новой сессии',
  'editor.btwSuggestionTitle': 'Похоже на попутный вопрос',
  'editor.btwSuggestionSend': 'Спросить через BTW',
  'environment.title': 'Окружение',
  'gitDiff.title': 'Изменения',
  'gitLog.title': 'История',
  'goals.title': 'Цели',
  'help.builtIn': 'Встроенные команды',
  'help.commandCount': (v) => `команд: ${v?.count ?? 0}`,
  'help.commandMeta.builtIn': 'встроенная',
  'help.commandMeta.custom': 'пользовательская',
  'help.commandsIntro': 'Встроенные команды:',
  'help.customGroup': 'Пользовательские, навыки, плагины, MCP',
  'help.customIntro': 'Пользовательские команды, навыки, плагины и MCP:',
  'help.empty': 'Сейчас нет доступных команд.',
  'help.emptyCustom': 'Сейчас нет пользовательских команд.',
  'help.footer':
    'Tab/Shift+Tab — вкладки · ↑/↓ или PgUp/PgDn — прокрутка · Esc — закрыть',
  'help.intro':
    'Довод отвечает на правовые вопросы с опорой на найденные источники, работает с материалами дела в рабочей папке и готовит документы с вашего разрешения.',
  'help.section.shortcuts': 'Сочетания клавиш',
  'help.search': 'Поиск команд',
  'help.shortcut.addContext': 'Добавить файлы или папки в контекст',
  'help.shortcut.clear': 'Очистить экран',
  'help.shortcut.commandMenu': 'Открыть меню команд',
  'help.shortcut.completion':
    'Принять подсказку или переключить вкладку справки',
  'help.shortcut.history': 'История запросов или прокрутка списков',
  'help.shortcut.searchHistory': 'Поиск по истории запросов',
  'help.shortcut.newline': 'Перенос строки',
  'help.shortcut.pasteImages': 'Вставить изображения',
  'help.shortcut.shell': 'Выполнять команды терминала',
  'help.shortcut.togglePanel': 'Показать/скрыть эту панель',
  'help.shortcut.retry': 'Повторить последний запрос',
  'help.shortcut.approvals': 'Переключить режим подтверждений',
  'help.shortcut.cancel': 'Закрыть диалог или отменить операцию',
  'help.subcommands': 'подкоманды',
  'help.tab.commands': 'Встроенные команды',
  'help.tab.custom': 'пользовательские',
  'help.tab.general': 'сочетания клавиш',
  'help.title': 'Справка',
  'language.changed': (v) => `Язык интерфейса: ${v?.language ?? ''}`,
  'language.current': (v) => `Текущий язык интерфейса: ${v?.language ?? ''}`,
  'language.invalid': 'Неверный язык. Доступны: ru, en, zh-CN',
  'language.options': 'Доступные варианты:',
  'language.set': 'Выбрать язык интерфейса',
  'language.usage': 'Использование: /language ui [ru|en|zh-CN]',
  'mcp.title': 'MCP-серверы',
  'mcp.empty': 'MCP-серверы не настроены.',
  'memory.loading': 'Загрузка памяти...',
  'mode.footer': '(Enter — выбрать, Esc — отмена)',
  'mode.label.plan': 'План',
  'mode.label.planReview': 'План и проверка',
  'mode.label.default': 'Спрашивать разрешение',
  'mode.label.auto-edit': 'Авто-правки',
  'mode.label.auto': 'Умное подтверждение',
  'mode.label.yolo': 'Полный доступ',
  'mode.listLabel.plan': 'План (plan)',
  'mode.listLabel.planReview': 'План и проверка (plan)',
  'mode.listLabel.default': 'Спрашивать разрешение (default)',
  'mode.listLabel.auto-edit': 'Авто-правки (auto-edit)',
  'mode.listLabel.auto': 'Умное подтверждение (auto)',
  'mode.listLabel.yolo': 'Полный доступ (yolo)',
  'mode.desc.plan': 'Только анализ: файлы не меняются, команды не выполняются',
  'mode.desc.planReview':
    'Режим плана с проверкой его шагов, когда план доступен',
  'mode.desc.default':
    'Спрашивать перед запуском команд, правкой файлов и обращением к внешним ресурсам',
  'mode.desc.auto-edit':
    'Автоматически разрешать правки файлов, спрашивать перед командами и другими чувствительными действиями',
  'mode.desc.auto':
    'Автоматически оценивать риск действий: безопасные выполнять, рискованные подтверждать',
  'mode.desc.yolo': 'Автоматически разрешать все действия в доверенных папках',
  'mode.select': 'Режим подтверждений',
  'mode.auto-edit': 'Авто-правки',
  'mode.auto-edit.desc': 'Автоматически разрешать чтение и запись файлов',
  'mode.default': 'Обычный режим',
  'mode.default.desc': 'Спрашивать перед каждым действием',
  'mode.plan': 'Режим плана',
  'mode.plan.desc': 'Анализ и план без выполнения действий',
  'mode.unknown': 'неизвестный режим',
  'mode.yolo': 'Режим полного доступа',
  'mode.yolo.desc': 'Автоматически разрешать все действия',
  'model.contextWindow': 'Окно контекста',
  'model.contextWindow.unknown': '(неизвестно)',
  'model.current': (v) => `текущая: ${v?.model ?? 'неизвестно'}`,
  'model.modality': 'Модальности',
  'model.baseUrl': 'Адрес API',
  'model.apiKey': 'Ключ API',
  'model.default': '(по умолчанию)',
  'model.notSet': '(не задано)',
  'model.footer': 'Enter — выбрать, ↑↓ — навигация, Esc — закрыть',
  'model.searchHint': 'Нажмите / для поиска',
  'model.fastHint': 'для подсказок и побочных задач',
  'model.noMatch': (v) => `Нет модели по запросу «${v?.query ?? ''}»`,
  'model.unavailable':
    'Модели недоступны; будет использована модель службы по умолчанию.',
  'model.none': 'Нет доступных моделей',
  'model.select': 'Выбор модели',
  'model.section': 'Модель',
  'model.setFast': 'Быстрая модель',
  'model.setVoice': 'Голосовая модель',
  'model.setVision': 'Модель для изображений',
  'model.switch': 'Сменить модель',
  'model.unknown': 'неизвестно',
  'model.usingModel': (v) =>
    `Используется ${v?.isRuntime ? 'модель среды' : 'модель'}: ${v?.modelId ?? ''}`,
  'plugins.extensions': 'Расширения',
  'plugins.agents': 'Агенты',
  'plugins.mcp': 'MCP',
  'plugins.sections': 'Разделы плагинов',
  'plugins.skills': 'Навыки',
  'plugins.title': 'Плагины',
  'plugins.tools': 'Инструменты',
  'quickActions.open': 'ещё действия',
  'quickActions.title': 'ещё действия',
  'quickActions.mcp': 'MCP',
  'quickActions.context': 'Контекст',
  'quickActions.status': 'Состояние',
  ...
  'quickActions.help': 'Справка',
  'quickActions.theme': 'Тема оформления',
  'quickActions.auth': 'Авторизация',
  'quickActions.settings': 'Настройки',
  'quickActions.new': 'Новая сессия',
  'quickActions.resume': 'Сменить сессию',
  'quickActions.delete': 'Удалить сессию',
  'quickActions.branch': 'Копировать сессию',
  'quickActions.rewind': 'Откатить сессию',
  'quickActions.historyQuestion': 'История вопросов',
  'quickActions.recap': 'Краткое резюме',
  'quickActions.copy': 'Копировать ответ',
  'quickActions.shellMode': 'Режим терминала',
  'quickActions.exitShellMode': 'Выйти из терминала',
  'quickActions.setGoal': 'Задать цель',
  'quickKeys.cursor': 'Переместить курсор',
  'quickKeys.escape': 'Прервать выполнение',
  'quickKeys.history': 'История',
  'quickKeys.retry': 'Повторить неудавшееся',
  'quickKeys.searchHistory': 'Поиск по истории',
  'quickKeys.tab': 'Принять подсказку',
  'resume.search': 'Поиск',
  'resume.title': 'Продолжить сессию',
  'rewind.title': 'Откатить переписку',
  'scheduledTasks.title': 'Запланированные задачи',
  'session.archived': 'Эта переписка в архиве',
  'session.archivedDescription': 'Восстановите её из архива, чтобы открыть.',
  'session.loadFailed': 'Не удалось загрузить переписку',
  'session.notFound': 'Переписка не найдена',
  'session.resolving': 'Открытие переписки...',
  'session.checkStatus': 'Проверить состояние',
  'session.retryCreation': 'Начать новую переписку',
  'session.repair': 'Восстановить папку',
  'session.repairing': 'Восстановление...',
  'session.unarchive': 'Из архива',
  'session.unarchiveFailed': 'Не удалось восстановить переписку из архива.',
  'session.missing': 'Текущая сессия не существует',
  'session.new': 'Новая сессия',
  'settings.title': 'Настройки',
  'settings.loading': 'Загрузка настроек...',
  'settings.empty': 'Настройки недоступны.',
  'settings.footer':
    '↑↓ — навигация  Enter — переключить  Tab — область  r — перечитать  ESC — закрыть',
  'settings.footer.edit': 'Enter — сохранить  ESC — отмена',
  'settings.footer.theme': '↑↓ — навигация  Enter — выбрать  ESC — назад',
  'settings.scope.user': 'Пользователь',
  'settings.scope.workspace': 'Рабочая папка',
  'settings.value.on': 'ВКЛ',
  'settings.value.off': 'ВЫКЛ',
  'settings.localControl.title': 'Доступ с телефона',
  'settings.localControl.on': 'Вкл',
  'settings.localControl.off': 'Выкл',
  'settings.localControl.network': 'Локальная сеть',
  'settings.localControl.selectNetwork': 'Выберите сеть',
  'settings.localControl.qr': 'QR-код доступа с телефона',
  'settings.localControl.enable': 'Включить доступ с телефона',
  ...
  'sidebar.toggleMenu': 'Меню',
  'sidebar.newChat': 'Новая переписка',
  'sidebar.newTask': 'Новая задача',
  'sidebar.newWorktreeTask': 'Новая задача в копии папки',
  'sidebar.plugins': 'Плагины',
  'sidebar.channels': 'Каналы',
  'sidebar.sessionSource': 'Источник сессий',
  'sidebar.sessionSource.tasks': 'Задачи',
  'sidebar.sessionSource.channels': 'Каналы',
  'sidebar.channelType.other': 'Другие каналы',
  'sidebar.live': 'Live',
  'sidebar.project': 'Дело',
  'sidebar.pinnedSessions': 'Закреплённые',
  'sidebar.workspaceSelectLabel': 'Рабочая папка',
  'sidebar.noWorkspace': 'Без рабочей папки',
  'sidebar.copySessionId': 'Копировать ID сессии',
  ...
  'sidebar.manageWorkspaces': 'Управление рабочими папками…',
  'sidebar.workspaceReadOnly': 'только чтение',
  'sidebar.workspaceTrustToOpen':
    'Отметьте папку как доверенную, чтобы открыть сессию.',
  'sidebar.addWorkspace': 'Добавить рабочую папку',
  'sidebar.newWorkspace': 'Новая рабочая папка',
  'sidebar.startFromScratch': 'Создать с нуля',
  'sidebar.useExistingFolder': 'Выбрать существующую папку…',
  'sidebar.addWorkspaceTitle': 'Добавить рабочую папку',
  'sidebar.addWorkspacePath': 'Путь к папке',
  'sidebar.addWorkspaceBrowse': 'Обзор…',
  'sidebar.addWorkspaceBrowseError':
    'Не удалось открыть системный выбор папки. Введите полный путь вручную.',
  'sidebar.addWorkspaceDisplayName': 'Отображаемое имя (необязательно)',
  'sidebar.addWorkspaceDisplayNameHint':
    'Показывается в интерфейсе; папка остаётся идентификатором рабочей области.',
  'sidebar.addWorkspaceRegister': 'Добавить',
  'sidebar.addWorkspaceCancel': 'Отмена',
  'sidebar.addWorkspaceError': 'Не удалось добавить рабочую папку',
  'sidebar.addWorkspaceBusyError': 'Другая операция с папками ещё выполняется',
  'sidebar.addWorkspaceAbsError': 'Путь должен быть полным',
  'sidebar.addWorkspaceHint': 'Введите полный путь к папке дела.',
  'sidebar.addWorkspaceSuggestions': 'Подсказки папок',
  'sidebar.addWorkspacePersist': 'Сохранять после перезапуска',
  'sidebar.addWorkspacePersistHint': 'Запомнить эту папку в настройках службы.',
  'sidebar.addWorkspaceAdding': 'Добавление…',
  'sidebar.removeWorkspace': 'Убрать рабочую папку',
  'sidebar.workspaceActions': 'Действия с папкой',
  'sidebar.renameWorkspace': 'Переименовать…',
  'sidebar.renameWorkspaceTitle': 'Переименовать рабочую папку',
  'sidebar.workspaceNamePrompt': 'Отображаемое имя',
  'sidebar.workspaceNameHint': 'Оставьте пустым, чтобы показывать имя папки.',
  'sidebar.workspaceNameInvalid': 'Имя не может содержать управляющие символы.',
  'sidebar.renameWorkspaceFailed': 'Не удалось переименовать рабочую папку',
  'sidebar.copyWorkspacePath': 'Копировать путь',
  'sidebar.copyWorkspacePathFailed': 'Не удалось скопировать путь',
  'sidebar.openWorkspaceFolder': 'Открыть папку',
  'sidebar.openWorkspaceFolderFailed': 'Не удалось открыть папку',
  'sidebar.openWorkspaceFolderOpened': 'Папка открыта',
  'sidebar.openWorkspaceTerminal': 'Открыть терминал',
  'sidebar.openWorkspaceTerminalFailed': 'Не удалось открыть терминал',
  'sidebar.openWorkspaceTerminalOpened': 'Терминал открыт в рабочей папке',
  'sidebar.manageWorkspace': 'Управление',
  'sidebar.reloadWorkspace': 'Перезапустить среду',
  'sidebar.reloadWorkspaceFailed': 'Не удалось перезапустить среду',
  'sidebar.workspaceCount': (v) => `рабочих папок: ${v?.count ?? 0}`,
  'sidebar.sessionsRunning': (v) => `активных сессий: ${v?.count ?? 0}`,
  'sidebar.sessionsAttention': (v) => `ждут вас: ${v?.count ?? 0}`,
  'sidebar.sessionsTotal': (v) =>
    `сессий: ${v?.count ?? 0}${v?.truncated ? '+' : ''}`,
  ...
  'sidebar.forceRemoveWorkspace': 'Убрать принудительно',
  'sidebar.removeWorkspaceTitle': 'Убрать рабочую папку',
  'sidebar.removeWorkspaceConfirm': (v) =>
    `Убрать «${v?.name ?? ''}» из списка? Файлы, настройки и история сессий не удаляются.`,
  'sidebar.removeWorkspaceError': 'Не удалось убрать рабочую папку',
  'sidebar.removeWorkspaceSessions': (v) => `Сессий: ${v?.count ?? 0}`,
  'sidebar.noSessions': 'Сессий нет.',
  'sidebar.projectFallback': 'Дело',
  'sidebar.sessionsOverview': 'Обзор сессий',
  'sidebar.splitView': 'Разделённый вид',
  'sidebar.settings': 'Настройки',
  'sidebar.daemonStatus': 'Состояние службы',
  'sidebar.scheduledTasks': 'Запланированные задачи',
  'sidebar.workflows': 'Сценарии',
  'sidebar.goals': 'Цели',
  ...
  'sidebar.collapseProject': 'Свернуть дело',
  'sidebar.expandProject': 'Развернуть дело',
  'sidebar.search': 'Поиск сессий',
  'sidebar.searchPlaceholder': 'Поиск сессий',
  'sidebar.rename': 'Переименовать',
  'sidebar.export': 'Экспортировать переписку',
  ...
  'sidebar.moreActions': 'Ещё действия',
  'sidebar.archiveCurrentDisabled': 'Текущую сессию нельзя отправить в архив',
  'sidebar.archiveRunningDisabled':
    'Активную сессию нельзя отправить в архив: это прервёт её ход',
  'sidebar.archivedTitle': 'Архив',
  'sidebar.recents': 'Недавние',
  'sidebar.noRecents': 'Недавних переписок нет',
  'sidebar.sessionActions': 'Действия с перепиской',
  'sidebar.standaloneLoadFailed': 'Не удалось загрузить недавние переписки',
  'sidebar.standaloneActionFailed': 'Действие с перепиской не выполнено',
  'sidebar.standaloneDeleteConfirm':
    'Удалить эту переписку и её служебные файлы?',
  'sidebar.archivedEmpty': 'В архиве пусто.',
  'sidebar.archiveFailed': 'Не удалось отправить сессию в архив',
  ...
  'sidebar.newSessionFailed': 'Не удалось создать новую переписку',
  'sidebar.switchFailed': 'Не удалось переключить сессию',
  'sidebar.currentDeleteDisabled': 'Текущую сессию нельзя удалить',
  'sidebar.deleteConfirmDescription': (v) =>
    `Удалить «${v?.name ?? ''}»? Это действие нельзя отменить.`,
  'sidebar.clients': (v) => `клиентов: ${v?.count ?? 0}`,
  'sidebar.running': 'Выполняется',
  'sidebar.waitingForApproval': 'Ждёт разрешения',
  'sidebar.waitingForApprovalShort': 'Разрешение',
  'sidebar.userInputNeeded': 'Нужен ваш ответ',
  'sidebar.userInputNeededShort': 'Ответ',
  'sidebar.completedUnread': 'Готово',
  ...
  'sidebar.groupPinned': 'Закреплённые',
  'sidebar.groupUngrouped': 'Без группы',
  ...
  'sidebar.groupDeleteConfirm': (v) => `Удалить группу «${v?.name ?? ''}»?`,
  'skills.title': 'Навыки',
  'skills.empty': 'Навыков нет.',
  'skills.loading': 'Загрузка навыков...',
  'skills.search': 'Поиск навыков…',
  'splitView.title': 'Разделённый вид',
  'splitView.count': (v) => `панелей: ${v?.count ?? 0}`,
  'splitView.addPane': 'Добавить сессию',
  'splitView.closePane': 'Закрыть панель',
  'splitView.maximizePane': 'Развернуть панель',
  'splitView.restorePane': 'Восстановить панель',
  'splitView.morePaneActions': 'Ещё действия с панелью',
  'splitView.paneError': 'В этой панели произошла ошибка',
  'splitView.paneConnectionError': 'Соединение потеряно',
  'splitView.outerApprovalPending': 'Основная сессия ждёт вашего разрешения.',
  'splitView.goToApproval': 'Перейти',
  'splitView.empty': 'В разделённом виде нет сессий. Добавьте одну.',
  'splitView.composerPlaceholder': 'Сообщение в эту сессию…',
  'stats.title': 'Статистика сессии',
  'terminal.title': 'Терминал',
  'terminal.open': 'Открыть терминал',
  'terminal.notice.error': (v) => `Ошибка: ${v?.message ?? ''}`,
  'terminal.notice.unknownError': 'Неизвестная ошибка',
  'terminal.notice.reconnecting': 'Связь потеряна — переподключение…',
  'theme.current': (v) => `текущая: ${v?.theme ?? ''}`,
  'theme.auto': 'Авто',
  'theme.dark': 'Тёмная',
  'theme.dark.desc': 'Тёмное оформление.',
  'theme.light': 'Светлая',
  'theme.light.desc': 'Светлое оформление.',
  'theme.title': 'Тема оформления',
  'thinking.expand': 'Показать рассуждения',
  'thinking.collapse': 'Скрыть рассуждения',
  'thinking.running': (v) => `Размышляет${v?.duration ? ` ${v.duration}` : ''}`,
  'thinking.doneBriefly': 'Коротко подумал',
  'thinking.done': (v) =>
    v?.duration ? `Размышлял ${v.duration}` : 'Рассуждения завершены',
  'thinking.translate': 'Перевести',
  'thinking.translation': 'Перевод рассуждений',
  'thinking.translating': 'Перевод...',
  'thinking.translationThinking': 'Размышляет...',
  'thinking.translationFailed': 'Перевод не удался',
  'thinking.retranslate': 'Перевести ещё раз',
  'thinking.cancelTranslation': 'Отмена',
  'thinking.closeTranslation': 'Закрыть',
  'thinking.inputTokens': (v) => `Входные токены: ${v?.count ?? '--'}`,
  'thinking.outputTokens': (v) => `Выходные токены: ${v?.count ?? '--'}`,
  'todo.title': 'Текущие задачи',
  'tokenUsage.title': 'Использование токенов',
  'tokenUsage.input': 'Вход',
  'tokenUsage.output': 'Выход всего',
  'tokenUsage.cached': 'Кэшированный вход',
  'tokenUsage.requests': 'Запросов',
  'tokenUsage.refresh': 'Обновить',
  'tokenUsage.retry': 'Повторить',
  'tokenUsage.noData': 'В этой сессии ещё не было обращений к модели.',
  'tokenUsage.loadError': 'Не удалось загрузить использование токенов.',
  'tokenUsage.open': 'Токены сессии',
  'turn.processed': 'Обработано',
  'turn.processing': 'Обработка',
  'turn.collapse': 'Свернуть шаги',
  'turn.expand': 'Развернуть шаги',
  'turn.cached': 'из кэша',
  'turn.executionSteps': (v) => `шагов: ${v?.count ?? 0}`,
  'turn.toolCalls': (v) => `вызовов инструментов: ${v?.count ?? 0}`,
  'turn.thinkingCount': (v) => `размышлений: ${v?.count ?? 0}`,
  'turn.stopped': 'Вы отменили этот запрос',
  'voice.noSpeech': 'Речь не распознана.',
  'voice.stopDictation': 'Остановить диктовку',
  'voice.transcribing': 'Распознавание…',
  'voice.starting': 'Запуск…',
  'voice.errorRetry': (v) =>
    `Ошибка голосового ввода — нажмите, чтобы повторить${v?.message ? `: ${v.message}` : ''}`,
  'voice.noSpeechRetry': 'Речь не распознана — нажмите, чтобы повторить',
  'voice.startDictation': 'Начать голосовой ввод',
  'voice.error': 'Ошибка голосового ввода',
  'welcome.changeModel': '(/model — сменить)',
  'welcome.defaultModel': 'модель не задана',
  'welcome.modeHint': 'Shift+Tab или /approval-mode',
  'welcome.prompt': 'Какой вопрос разберём?',
...
export function normalizeLanguage(
  ...
  // DOVOD: Russian is the product default. English and Chinese stay
  // selectable; anything else (including an empty value) resolves to ru.
